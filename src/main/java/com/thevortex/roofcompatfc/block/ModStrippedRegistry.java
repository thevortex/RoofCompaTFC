...
public class ModStrippedRegistry {
        ...
        public static final RegistryObject<Block> stripped_ash_roof = createBlock("stripped_ash_roof", () -> new StairBlock(Blocks.OAK_PLANKS.defaultBlockState(), Block.Properties.of(Material.WOOD).noOcclusion().strength(2.0F, 2.0F).sound(SoundType.WOOD)));
        ...
        public static final RegistryObject<Block> stripped_ash_lower_roof = createBlock("stripped_ash_lower_roof", () -> new StairBlock(Blocks.OAK_PLANKS.defaultBlockState(), Block.Properties.of(Material.WOOD).noOcclusion().strength(2.0F, 2.0F).sound(SoundType.WOOD)));
        public static final RegistryObject<Block> stripped_ash_steep_roof = createBlock("stripped_ash_steep_roof", () -> new StairBlock(Blocks.OAK_PLANKS.defaultBlockState(), Block.Properties.of(Material.WOOD).noOcclusion().strength(2.0F, 2.0F).sound(SoundType.WOOD)));
        ...
        public static final RegistryObject<Block> stripped_aspen_roof = createBlock("stripped_aspen_roof", () -> new StairBlock(Blocks.OAK_PLANKS.defaultBlockState(), Block.Properties.of(Material.WOOD).noOcclusion().strength(2.0F, 2.0F).sound(SoundType.WOOD)));
        ...
        public static final RegistryObject<Block> stripped_aspen_lower_roof = createBlock("stripped_aspen_lower_roof", () -> new StairBlock(Blocks.OAK_PLANKS.defaultBlockState(), Block.Properties.of(Material.WOOD).noOcclusion().strength(2.0F, 2.0F).sound(SoundType.WOOD)));
        public static final RegistryObject<Block> stripped_aspen_steep_roof = createBlock("stripped_aspen_steep_roof", () -> new StairBlock(Blocks.OAK_PLANKS.defaultBlockState(), Block.Properties.of(Material.WOOD).noOcclusion().strength(2.0F, 2.0F).sound(SoundType.WOOD)));
        ...
        public static final RegistryObject<Block> stripped_blackwood_roof = createBlock("stripped_blackwood_roof", () -> new StairBlock(Blocks.OAK_PLANKS.defaultBlockState(), Block.Properties.of(Material.WOOD).noOcclusion().strength(2.0F, 2.0F).sound(SoundType.WOOD)));
        ...
        public static final RegistryObject<Block> stripped_blackwood_lower_roof = createBlock("stripped_blackwood_lower_roof", () -> new StairBlock(Blocks.OAK_PLANKS.defaultBlockState(), Block.Properties.of(Material.WOOD).noOcclusion().strength(2.0F, 2.0F).sound(SoundType.WOOD)));
        public static final RegistryObject<Block> stripped_blackwood_steep_roof = createBlock("stripped_blackwood_steep_roof", () -> new StairBlock(Blocks.OAK_PLANKS.defaultBlockState(), Block.Properties.of(Material.WOOD).noOcclusion().strength(2.0F, 2.0F).sound(SoundType.WOOD)));
        ...
        public static final RegistryObject<Block> stripped_chestnut_roof = createBlock("stripped_chestnut_roof", () -> new StairBlock(Blocks.OAK_PLANKS.defaultBlockState(), Block.Properties.of(Material.WOOD).noOcclusion().strength(2.0F, 2.0F).sound(SoundType.WOOD)));
        ...
        public static final RegistryObject<Block> stripped_chestnut_lower_roof = createBlock("stripped_chestnut_lower_roof", () -> new StairBlock(Blocks.OAK_PLANKS.defaultBlockState(), Block.Properties.of(Material.WOOD).noOcclusion().strength(2.0F, 2.0F).sound(SoundType.WOOD)));
        public static final RegistryObject<Block> stripped_chestnut_steep_roof = createBlock("stripped_chestnut_steep_roof", () -> new StairBlock(Blocks.OAK_PLANKS.defaultBlockState(), Block.Properties.of(Material.WOOD).noOcclusion().strength(2.0F, 2.0F).sound(SoundType.WOOD)));
        ...
        public static final RegistryObject<Block> stripped_douglas_fir_roof = createBlock("stripped_douglas_fir_roof", () -> new StairBlock(Blocks.OAK_PLANKS.defaultBlockState(), Block.Properties.of(Material.WOOD).noOcclusion().strength(2.0F, 2.0F).sound(SoundType.WOOD)));
        ...
        public static final RegistryObject<Block> stripped_douglas_fir_lower_roof = createBlock("stripped_douglas_fir_lower_roof", () -> new StairBlock(Blocks.OAK_PLANKS.defaultBlockState(), Block.Properties.of(Material.WOOD).noOcclusion().strength(2.0F, 2.0F).sound(SoundType.WOOD)));
        public static final RegistryObject<Block> stripped_douglas_fir_steep_roof = createBlock("stripped_douglas_fir_steep_roof", () -> new StairBlock(Blocks.OAK_PLANKS.defaultBlockState(), Block.Properties.of(Material.WOOD).noOcclusion().strength(2.0F, 2.0F).sound(SoundType.WOOD)));
        ...
        public static final RegistryObject<Block> stripped_hickory_roof = createBlock("stripped_hickory_roof", () -> new StairBlock(Blocks.OAK_PLANKS.defaultBlockState(), Block.Properties.of(Material.WOOD).noOcclusion().strength(2.0F, 2.0F).sound(SoundType.WOOD)));
        ...
        public static final RegistryObject<Block> stripped_hickory_lower_roof = createBlock("stripped_hickory_lower_roof", () -> new StairBlock(Blocks.OAK_PLANKS.defaultBlockState(), Block.Properties.of(Material.WOOD).noOcclusion().strength(2.0F, 2.0F).sound(SoundType.WOOD)));
        public static final RegistryObject<Block> stripped_hickory_steep_roof = createBlock("stripped_hickory_steep_roof", () -> new StairBlock(Blocks.OAK_PLANKS.defaultBlockState(), Block.Properties.of(Material.WOOD).noOcclusion().strength(2.0F, 2.0F).sound(SoundType.WOOD)));
        ...
        public static final RegistryObject<Block> stripped_kapok_roof = createBlock("stripped_kapok_roof", () -> new StairBlock(Blocks.OAK_PLANKS.defaultBlockState(), Block.Properties.of(Material.WOOD).noOcclusion().strength(2.0F, 2.0F).sound(SoundType.WOOD)));
        ...
        public static final RegistryObject<Block> stripped_kapok_lower_roof = createBlock("stripped_kapok_lower_roof", () -> new StairBlock(Blocks.OAK_PLANKS.defaultBlockState(), Block.Properties.of(Material.WOOD).noOcclusion().strength(2.0F, 2.0F).sound(SoundType.WOOD)));
        public static final RegistryObject<Block> stripped_kapok_steep_roof = createBlock("stripped_kapok_steep_roof", () -> new StairBlock(Blocks.OAK_PLANKS.defaultBlockState(), Block.Properties.of(Material.WOOD).noOcclusion().strength(2.0F, 2.0F).sound(SoundType.WOOD)));
        ...
        public static final RegistryObject<Block> stripped_maple_roof = createBlock("stripped_maple_roof", () -> new StairBlock(Blocks.OAK_PLANKS.defaultBlockState(), Block.Properties.of(Material.WOOD).noOcclusion().strength(2.0F, 2.0F).sound(SoundType.WOOD)));
        ...
        public static final RegistryObject<Block> stripped_maple_lower_roof = createBlock("stripped_maple_lower_roof", () -> new StairBlock(Blocks.OAK_PLANKS.defaultBlockState(), Block.Properties.of(Material.WOOD).noOcclusion().strength(2.0F, 2.0F).sound(SoundType.WOOD)));
        public static final RegistryObject<Block> stripped_maple_steep_roof = createBlock("stripped_maple_steep_roof", () -> new StairBlock(Blocks.OAK_PLANKS.defaultBlockState(), Block.Properties.of(Material.WOOD).noOcclusion().strength(2.0F, 2.0F).sound(SoundType.WOOD)));
        ...
        public static final RegistryObject<Block> stripped_palm_roof = createBlock("stripped_palm_roof", () -> new StairBlock(Blocks.OAK_PLANKS.defaultBlockState(), Block.Properties.of(Material.WOOD).noOcclusion().strength(2.0F, 2.0F).sound(SoundType.WOOD)));
        ...
        public static final RegistryObject<Block> stripped_palm_lower_roof = createBlock("stripped_palm_lower_roof", () -> new StairBlock(Blocks.OAK_PLANKS.defaultBlockState(), Block.Properties.of(Material.WOOD).noOcclusion().strength(2.0F, 2.0F).sound(SoundType.WOOD)));
        public static final RegistryObject<Block> stripped_palm_steep_roof = createBlock("stripped_palm_steep_roof", () -> new StairBlock(Blocks.OAK_PLANKS.defaultBlockState(), Block.Properties.of(Material.WOOD).noOcclusion().strength(2.0F, 2.0F).sound(SoundType.WOOD)));
        ...
        public static final RegistryObject<Block> stripped_pine_roof = createBlock("stripped_pine_roof", () -> new StairBlock(Blocks.OAK_PLANKS.defaultBlockState(), Block.Properties.of(Material.WOOD).noOcclusion().strength(2.0F, 2.0F).sound(SoundType.WOOD)));
        ...
        public static final RegistryObject<Block> stripped_pine_lower_roof = createBlock("stripped_pine_lower_roof", () -> new StairBlock(Blocks.OAK_PLANKS.defaultBlockState(), Block.Properties.of(Material.WOOD).noOcclusion().strength(2.0F, 2.0F).sound(SoundType.WOOD)));
        public static final RegistryObject<Block> stripped_pine_steep_roof = createBlock("stripped_pine_steep_roof", () -> new StairBlock(Blocks.OAK_PLANKS.defaultBlockState(), Block.Properties.of(Material.WOOD).noOcclusion().strength(2.0F, 2.0F).sound(SoundType.WOOD)));
        ...
        public static final RegistryObject<Block> stripped_rosewood_roof = createBlock("stripped_rosewood_roof", () -> new StairBlock(Blocks.OAK_PLANKS.defaultBlockState(), Block.Properties.of(Material.WOOD).noOcclusion().strength(2.0F, 2.0F).sound(SoundType.WOOD)));
        ...
        public static final RegistryObject<Block> stripped_rosewood_lower_roof = createBlock("stripped_rosewood_lower_roof", () -> new StairBlock(Blocks.OAK_PLANKS.defaultBlockState(), Block.Properties.of(Material.WOOD).noOcclusion().strength(2.0F, 2.0F).sound(SoundType.WOOD)));
        public static final RegistryObject<Block> stripped_rosewood_steep_roof = createBlock("stripped_rosewood_steep_roof", () -> new StairBlock(Blocks.OAK_PLANKS.defaultBlockState(), Block.Properties.of(Material.WOOD).noOcclusion().strength(2.0F, 2.0F).sound(SoundType.WOOD)));
        ...
        public static final RegistryObject<Block> stripped_sequoia_roof = createBlock("stripped_sequoia_roof", () -> new StairBlock(Blocks.OAK_PLANKS.defaultBlockState(), Block.Properties.of(Material.WOOD).noOcclusion().strength(2.0F, 2.0F).sound(SoundType.WOOD)));
        ...
        public static final RegistryObject<Block> stripped_sequoia_lower_roof = createBlock("stripped_sequoia_lower_roof", () -> new StairBlock(Blocks.OAK_PLANKS.defaultBlockState(), Block.Properties.of(Material.WOOD).noOcclusion().strength(2.0F, 2.0F).sound(SoundType.WOOD)));
        public static final RegistryObject<Block> stripped_sequoia_steep_roof = createBlock("stripped_sequoia_steep_roof", () -> new StairBlock(Blocks.OAK_PLANKS.defaultBlockState(), Block.Properties.of(Material.WOOD).noOcclusion().strength(2.0F, 2.0F).sound(SoundType.WOOD)));
        ...
        public static final RegistryObject<Block> stripped_sycamore_roof = createBlock("stripped_sycamore_roof", () -> new StairBlock(Blocks.OAK_PLANKS.defaultBlockState(), Block.Properties.of(Material.WOOD).noOcclusion().strength(2.0F, 2.0F).sound(SoundType.WOOD)));
        ...
        public static final RegistryObject<Block> stripped_sycamore_lower_roof = createBlock("stripped_sycamore_lower_roof", () -> new StairBlock(Blocks.OAK_PLANKS.defaultBlockState(), Block.Properties.of(Material.WOOD).noOcclusion().strength(2.0F, 2.0F).sound(SoundType.WOOD)));
        public static final RegistryObject<Block> stripped_sycamore_steep_roof = createBlock("stripped_sycamore_steep_roof", () -> new StairBlock(Blocks.OAK_PLANKS.defaultBlockState(), Block.Properties.of(Material.WOOD).noOcclusion().strength(2.0F, 2.0F).sound(SoundType.WOOD)));
        ...
        public static final RegistryObject<Block> stripped_white_cedar_roof = createBlock("stripped_white_cedar_roof", () -> new StairBlock(Blocks.OAK_PLANKS.defaultBlockState(), Block.Properties.of(Material.WOOD).noOcclusion().strength(2.0F, 2.0F).sound(SoundType.WOOD)));
        ...
        public static final RegistryObject<Block> stripped_white_cedar_lower_roof = createBlock("stripped_white_cedar_lower_roof", () -> new StairBlock(Blocks.OAK_PLANKS.defaultBlockState(), Block.Properties.of(Material.WOOD).noOcclusion().strength(2.0F, 2.0F).sound(SoundType.WOOD)));
        public static final RegistryObject<Block> stripped_white_cedar_steep_roof = createBlock("stripped_white_cedar_steep_roof", () -> new StairBlock(Blocks.OAK_PLANKS.defaultBlockState(), Block.Properties.of(Material.WOOD).noOcclusion().strength(2.0F, 2.0F).sound(SoundType.WOOD)));
        ...
        public static final RegistryObject<Block> stripped_willow_roof = createBlock("stripped_willow_roof", () -> new StairBlock(Blocks.OAK_PLANKS.defaultBlockState(), Block.Properties.of(Material.WOOD).noOcclusion().strength(2.0F, 2.0F).sound(SoundType.WOOD)));
        ...
        public static final RegistryObject<Block> stripped_willow_lower_roof = createBlock("stripped_willow_lower_roof", () -> new StairBlock(Blocks.OAK_PLANKS.defaultBlockState(), Block.Properties.of(Material.WOOD).noOcclusion().strength(2.0F, 2.0F).sound(SoundType.WOOD)));
        public static final RegistryObject<Block> stripped_willow_steep_roof = createBlock("stripped_willow_steep_roof", () -> new StairBlock(Blocks.OAK_PLANKS.defaultBlockState(), Block.Properties.of(Material.WOOD).noOcclusion().strength(2.0F, 2.0F).sound(SoundType.WOOD)));
