...
public class ModStoneRegistry {
    ...
    public static final RegistryObject<Block> andesite_roof = createBlock("andesite_roof", () -> new BaseRoof(Blocks.OAK_PLANKS.defaultBlockState(), Block.Properties.of(Material.WOOD).noOcclusion().strength(2.0F, 2.0F).sound(SoundType.WOOD)));
    ...
    public static final RegistryObject<Block> andesite_lower_roof = createBlock("andesite_lower_roof", () -> new BaseRoof(Blocks.OAK_PLANKS.defaultBlockState(), Block.Properties.of(Material.WOOD).noOcclusion().strength(2.0F, 2.0F).sound(SoundType.WOOD)));
    public static final RegistryObject<Block> andesite_steep_roof = createBlock("andesite_steep_roof", () -> new BaseRoof(Blocks.OAK_PLANKS.defaultBlockState(), Block.Properties.of(Material.WOOD).noOcclusion().strength(2.0F, 2.0F).sound(SoundType.WOOD)));
    ...
    public static final RegistryObject<Block> basalt_roof = createBlock("basalt_roof", () -> new BaseRoof(Blocks.OAK_PLANKS.defaultBlockState(), Block.Properties.of(Material.WOOD).noOcclusion().strength(2.0F, 2.0F).sound(SoundType.WOOD)));
    ...
    public static final RegistryObject<Block> basalt_lower_roof = createBlock("basalt_lower_roof", () -> new BaseRoof(Blocks.OAK_PLANKS.defaultBlockState(), Block.Properties.of(Material.WOOD).noOcclusion().strength(2.0F, 2.0F).sound(SoundType.WOOD)));
    public static final RegistryObject<Block> basalt_steep_roof = createBlock("basalt_steep_roof", () -> new BaseRoof(Blocks.OAK_PLANKS.defaultBlockState(), Block.Properties.of(Material.WOOD).noOcclusion().strength(2.0F, 2.0F).sound(SoundType.WOOD)));
    ...
    public static final RegistryObject<Block> chalk_roof = createBlock("chalk_roof", () -> new BaseRoof(Blocks.OAK_PLANKS.defaultBlockState(), Block.Properties.of(Material.WOOD).noOcclusion().strength(2.0F, 2.0F).sound(SoundType.WOOD)));
    ...
    public static final RegistryObject<Block> chalk_lower_roof = createBlock("chalk_lower_roof", () -> new BaseRoof(Blocks.OAK_PLANKS.defaultBlockState(), Block.Properties.of(Material.WOOD).noOcclusion().strength(2.0F, 2.0F).sound(SoundType.WOOD)));
    public static final RegistryObject<Block> chalk_steep_roof = createBlock("chalk_steep_roof", () -> new BaseRoof(Blocks.OAK_PLANKS.defaultBlockState(), Block.Properties.of(Material.WOOD).noOcclusion().strength(2.0F, 2.0F).sound(SoundType.WOOD)));
    ...
    public static final RegistryObject<Block> chert_roof = createBlock("chert_roof", () -> new BaseRoof(Blocks.OAK_PLANKS.defaultBlockState(), Block.Properties.of(Material.WOOD).noOcclusion().strength(2.0F, 2.0F).sound(SoundType.WOOD)));
    ...
    public static final RegistryObject<Block> chert_lower_roof = createBlock("chert_lower_roof", () -> new BaseRoof(Blocks.OAK_PLANKS.defaultBlockState(), Block.Properties.of(Material.WOOD).noOcclusion().strength(2.0F, 2.0F).sound(SoundType.WOOD)));
    public static final RegistryObject<Block> chert_steep_roof = createBlock("chert_steep_roof", () -> new BaseRoof(Blocks.OAK_PLANKS.defaultBlockState(), Block.Properties.of(Material.WOOD).noOcclusion().strength(2.0F, 2.0F).sound(SoundType.WOOD)));
    ...
    public static final RegistryObject<Block> claystone_roof = createBlock("claystone_roof", () -> new BaseRoof(Blocks.OAK_PLANKS.defaultBlockState(), Block.Properties.of(Material.WOOD).noOcclusion().strength(2.0F, 2.0F).sound(SoundType.WOOD)));
    ...
    public static final RegistryObject<Block> claystone_lower_roof = createBlock("claystone_lower_roof", () -> new BaseRoof(Blocks.OAK_PLANKS.defaultBlockState(), Block.Properties.of(Material.WOOD).noOcclusion().strength(2.0F, 2.0F).sound(SoundType.WOOD)));
    public static final RegistryObject<Block> claystone_steep_roof = createBlock("claystone_steep_roof", () -> new BaseRoof(Blocks.OAK_PLANKS.defaultBlockState(), Block.Properties.of(Material.WOOD).noOcclusion().strength(2.0F, 2.0F).sound(SoundType.WOOD)));
    ...
    public static final RegistryObject<Block> conglomerate_roof = createBlock("conglomerate_roof", () -> new BaseRoof(Blocks.OAK_PLANKS.defaultBlockState(), Block.Properties.of(Material.WOOD).noOcclusion().strength(2.0F, 2.0F).sound(SoundType.WOOD)));
    ...
    public static final RegistryObject<Block> conglomerate_lower_roof = createBlock("conglomerate_lower_roof", () -> new BaseRoof(Blocks.OAK_PLANKS.defaultBlockState(), Block.Properties.of(Material.WOOD).noOcclusion().strength(2.0F, 2.0F).sound(SoundType.WOOD)));
    public static final RegistryObject<Block> conglomerate_steep_roof = createBlock("conglomerate_steep_roof", () -> new BaseRoof(Blocks.OAK_PLANKS.defaultBlockState(), Block.Properties.of(Material.WOOD).noOcclusion().strength(2.0F, 2.0F).sound(SoundType.WOOD)));
    ...
    public static final RegistryObject<Block> dacite_roof = createBlock("dacite_roof", () -> new BaseRoof(Blocks.OAK_PLANKS.defaultBlockState(), Block.Properties.of(Material.WOOD).noOcclusion().strength(2.0F, 2.0F).sound(SoundType.WOOD)));
    ...
    public static final RegistryObject<Block> dacite_lower_roof = createBlock("dacite_lower_roof", () -> new BaseRoof(Blocks.OAK_PLANKS.defaultBlockState(), Block.Properties.of(Material.WOOD).noOcclusion().strength(2.0F, 2.0F).sound(SoundType.WOOD)));
    public static final RegistryObject<Block> dacite_steep_roof = createBlock("dacite_steep_roof", () -> new BaseRoof(Blocks.OAK_PLANKS.defaultBlockState(), Block.Properties.of(Material.WOOD).noOcclusion().strength(2.0F, 2.0F).sound(SoundType.WOOD)));
    ...
    public static final RegistryObject<Block> diorite_roof = createBlock("diorite_roof", () -> new BaseRoof(Blocks.OAK_PLANKS.defaultBlockState(), Block.Properties.of(Material.WOOD).noOcclusion().strength(2.0F, 2.0F).sound(SoundType.WOOD)));
    ...
    public static final RegistryObject<Block> diorite_lower_roof = createBlock("diorite_lower_roof", () -> new BaseRoof(Blocks.OAK_PLANKS.defaultBlockState(), Block.Properties.of(Material.WOOD).noOcclusion().strength(2.0F, 2.0F).sound(SoundType.WOOD)));
    public static final RegistryObject<Block> diorite_steep_roof = createBlock("diorite_steep_roof", () -> new BaseRoof(Blocks.OAK_PLANKS.defaultBlockState(), Block.Properties.of(Material.WOOD).noOcclusion().strength(2.0F, 2.0F).sound(SoundType.WOOD)));
    ...
    public static final RegistryObject<Block> dolomite_roof = createBlock("dolomite_roof", () -> new BaseRoof(Blocks.OAK_PLANKS.defaultBlockState(), Block.Properties.of(Material.WOOD).noOcclusion().strength(2.0F, 2.0F).sound(SoundType.WOOD)));
    ...
    public static final RegistryObject<Block> dolomite_lower_roof = createBlock("dolomite_lower_roof", () -> new BaseRoof(Blocks.OAK_PLANKS.defaultBlockState(), Block.Properties.of(Material.WOOD).noOcclusion().strength(2.0F, 2.0F).sound(SoundType.WOOD)));
    public static final RegistryObject<Block> dolomite_steep_roof = createBlock("dolomite_steep_roof", () -> new BaseRoof(Blocks.OAK_PLANKS.defaultBlockState(), Block.Properties.of(Material.WOOD).noOcclusion().strength(2.0F, 2.0F).sound(SoundType.WOOD)));
    ...
    public static final RegistryObject<Block> gabbro_roof = createBlock("gabbro_roof", () -> new BaseRoof(Blocks.OAK_PLANKS.defaultBlockState(), Block.Properties.of(Material.WOOD).noOcclusion().strength(2.0F, 2.0F).sound(SoundType.WOOD)));
    ...
    public static final RegistryObject<Block> gabbro_lower_roof = createBlock("gabbro_lower_roof", () -> new BaseRoof(Blocks.OAK_PLANKS.defaultBlockState(), Block.Properties.of(Material.WOOD).noOcclusion().strength(2.0F, 2.0F).sound(SoundType.WOOD)));
    public static final RegistryObject<Block> gabbro_steep_roof = createBlock("gabbro_steep_roof", () -> new BaseRoof(Blocks.OAK_PLANKS.defaultBlockState(), Block.Properties.of(Material.WOOD).noOcclusion().strength(2.0F, 2.0F).sound(SoundType.WOOD)));
    ...
    public static final RegistryObject<Block> gneiss_roof = createBlock("gneiss_roof", () -> new BaseRoof(Blocks.OAK_PLANKS.defaultBlockState(), Block.Properties.of(Material.WOOD).noOcclusion().strength(2.0F, 2.0F).sound(SoundType.WOOD)));
    ...
    public static final RegistryObject<Block> gneiss_lower_roof = createBlock("gneiss_lower_roof", () -> new BaseRoof(Blocks.OAK_PLANKS.defaultBlockState(), Block.Properties.of(Material.WOOD).noOcclusion().strength(2.0F, 2.0F).sound(SoundType.WOOD)));
    public static final RegistryObject<Block> gneiss_steep_roof = createBlock("gneiss_steep_roof", () -> new BaseRoof(Blocks.OAK_PLANKS.defaultBlockState(), Block.Properties.of(Material.WOOD).noOcclusion().strength(2.0F, 2.0F).sound(SoundType.WOOD)));
    ...
    public static final RegistryObject<Block> granite_roof = createBlock("granite_roof", () -> new BaseRoof(Blocks.OAK_PLANKS.defaultBlockState(), Block.Properties.of(Material.WOOD).noOcclusion().strength(2.0F, 2.0F).sound(SoundType.WOOD)));
    ...
    public static final RegistryObject<Block> granite_lower_roof = createBlock("granite_lower_roof", () -> new BaseRoof(Blocks.OAK_PLANKS.defaultBlockState(), Block.Properties.of(Material.WOOD).noOcclusion().strength(2.0F, 2.0F).sound(SoundType.WOOD)));
    public static final RegistryObject<Block> granite_steep_roof = createBlock("granite_steep_roof", () -> new BaseRoof(Blocks.OAK_PLANKS.defaultBlockState(), Block.Properties.of(Material.WOOD).noOcclusion().strength(2.0F, 2.0F).sound(SoundType.WOOD)));
    ...
    public static final RegistryObject<Block> limestone_roof = createBlock("limestone_roof", () -> new BaseRoof(Blocks.OAK_PLANKS.defaultBlockState(), Block.Properties.of(Material.WOOD).noOcclusion().strength(2.0F, 2.0F).sound(SoundType.WOOD)));
    ...
    public static final RegistryObject<Block> limestone_lower_roof = createBlock("limestone_lower_roof", () -> new BaseRoof(Blocks.OAK_PLANKS.defaultBlockState(), Block.Properties.of(Material.WOOD).noOcclusion().strength(2.0F, 2.0F).sound(SoundType.WOOD)));
    public static final RegistryObject<Block> limestone_steep_roof = createBlock("limestone_steep_roof", () -> new BaseRoof(Blocks.OAK_PLANKS.defaultBlockState(), Block.Properties.of(Material.WOOD).noOcclusion().strength(2.0F, 2.0F).sound(SoundType.WOOD)));
    ...
    public static final RegistryObject<Block> marble_roof = createBlock("marble_roof", () -> new BaseRoof(Blocks.OAK_PLANKS.defaultBlockState(), Block.Properties.of(Material.WOOD).noOcclusion().strength(2.0F, 2.0F).sound(SoundType.WOOD)));
    ...
    public static final RegistryObject<Block> marble_lower_roof = createBlock("marble_lower_roof", () -> new BaseRoof(Blocks.OAK_PLANKS.defaultBlockState(), Block.Properties.of(Material.WOOD).noOcclusion().strength(2.0F, 2.0F).sound(SoundType.WOOD)));
    public static final RegistryObject<Block> marble_steep_roof = createBlock("marble_steep_roof", () -> new BaseRoof(Blocks.OAK_PLANKS.defaultBlockState(), Block.Properties.of(Material.WOOD).noOcclusion().strength(2.0F, 2.0F).sound(SoundType.WOOD)));
    ...
    public static final RegistryObject<Block> phyllite_roof = createBlock("phyllite_roof", () -> new BaseRoof(Blocks.OAK_PLANKS.defaultBlockState(), Block.Properties.of(Material.WOOD).noOcclusion().strength(2.0F, 2.0F).sound(SoundType.WOOD)));
    ...
    public static final RegistryObject<Block> phyllite_lower_roof = createBlock("phyllite_lower_roof", () -> new BaseRoof(Blocks.OAK_PLANKS.defaultBlockState(), Block.Properties.of(Material.WOOD).noOcclusion().strength(2.0F, 2.0F).sound(SoundType.WOOD)));
    public static final RegistryObject<Block> phyllite_steep_roof = createBlock("phyllite_steep_roof", () -> new BaseRoof(Blocks.OAK_PLANKS.defaultBlockState(), Block.Properties.of(Material.WOOD).noOcclusion().strength(2.0F, 2.0F).sound(SoundType.WOOD)));
    ...
    public static final RegistryObject<Block> quartzite_roof = createBlock("quartzite_roof", () -> new BaseRoof(Blocks.OAK_PLANKS.defaultBlockState(), Block.Properties.of(Material.WOOD).noOcclusion().strength(2.0F, 2.0F).sound(SoundType.WOOD)));
    ...
    public static final RegistryObject<Block> quartzite_lower_roof = createBlock("quartzite_lower_roof", () -> new BaseRoof(Blocks.OAK_PLANKS.defaultBlockState(), Block.Properties.of(Material.WOOD).noOcclusion().strength(2.0F, 2.0F).sound(SoundType.WOOD)));
    public static final RegistryObject<Block> quartzite_steep_roof = createBlock("quartzite_steep_roof", () -> new BaseRoof(Blocks.OAK_PLANKS.defaultBlockState(), Block.Properties.of(Material.WOOD).noOcclusion().strength(2.0F, 2.0F).sound(SoundType.WOOD)));
    ...
    public static final RegistryObject<Block> rhyolite_roof = createBlock("rhyolite_roof", () -> new BaseRoof(Blocks.OAK_PLANKS.defaultBlockState(), Block.Properties.of(Material.WOOD).noOcclusion().strength(2.0F, 2.0F).sound(SoundType.WOOD)));
    ...
    public static final RegistryObject<Block> rhyolite_lower_roof = createBlock("rhyolite_lower_roof", () -> new BaseRoof(Blocks.OAK_PLANKS.defaultBlockState(), Block.Properties.of(Material.WOOD).noOcclusion().strength(2.0F, 2.0F).sound(SoundType.WOOD)));
    public static final RegistryObject<Block> rhyolite_steep_roof = createBlock("rhyolite_steep_roof", () -> new BaseRoof(Blocks.OAK_PLANKS.defaultBlockState(), Block.Properties.of(Material.WOOD).noOcclusion().strength(2.0F, 2.0F).sound(SoundType.WOOD)));
    ...
    public static final RegistryObject<Block> schist_roof = createBlock("schist_roof", () -> new BaseRoof(Blocks.OAK_PLANKS.defaultBlockState(), Block.Properties.of(Material.WOOD).noOcclusion().strength(2.0F, 2.0F).sound(SoundType.WOOD)));
    ...
    public static final RegistryObject<Block> schist_lower_roof = createBlock("schist_lower_roof", () -> new BaseRoof(Blocks.OAK_PLANKS.defaultBlockState(), Block.Properties.of(Material.WOOD).noOcclusion().strength(2.0F, 2.0F).sound(SoundType.WOOD)));
    public static final RegistryObject<Block> schist_steep_roof = createBlock("schist_steep_roof", () -> new BaseRoof(Blocks.OAK_PLANKS.defaultBlockState(), Block.Properties.of(Material.WOOD).noOcclusion().strength(2.0F, 2.0F).sound(SoundType.WOOD)));
    ...
    public static final RegistryObject<Block> shale_roof = createBlock("shale_roof", () -> new BaseRoof(Blocks.OAK_PLANKS.defaultBlockState(), Block.Properties.of(Material.WOOD).noOcclusion().strength(2.0F, 2.0F).sound(SoundType.WOOD)));
    ...
    public static final RegistryObject<Block> shale_lower_roof = createBlock("shale_lower_roof", () -> new BaseRoof(Blocks.OAK_PLANKS.defaultBlockState(), Block.Properties.of(Material.WOOD).noOcclusion().strength(2.0F, 2.0F).sound(SoundType.WOOD)));
    public static final RegistryObject<Block> shale_steep_roof = createBlock("shale_steep_roof", () -> new BaseRoof(Blocks.OAK_PLANKS.defaultBlockState(), Block.Properties.of(Material.WOOD).noOcclusion().strength(2.0F, 2.0F).sound(SoundType.WOOD)));
    ...
    public static final RegistryObject<Block> slate_roof = createBlock("slate_roof", () -> new BaseRoof(Blocks.OAK_PLANKS.defaultBlockState(), Block.Properties.of(Material.WOOD).noOcclusion().strength(2.0F, 2.0F).sound(SoundType.WOOD)));
    ...
    public static final RegistryObject<Block> slate_lower_roof = createBlock("slate_lower_roof", () -> new BaseRoof(Blocks.OAK_PLANKS.defaultBlockState(), Block.Properties.of(Material.WOOD).noOcclusion().strength(2.0F, 2.0F).sound(SoundType.WOOD)));
    public static final RegistryObject<Block> slate_steep_roof = createBlock("slate_steep_roof", () -> new BaseRoof(Blocks.OAK_PLANKS.defaultBlockState(), Block.Properties.of(Material.WOOD).noOcclusion().strength(2.0F, 2.0F).sound(SoundType.WOOD)));
