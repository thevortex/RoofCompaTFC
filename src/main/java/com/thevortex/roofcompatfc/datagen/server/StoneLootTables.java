...
public class StoneLootTables extends LootTableProvider {

    public StoneLootTables(DataGenerator generator) {
        super(generator);
    }
    ...
    public static class Blocks extends BlockLoot
    {
        ...
        {
            return ModStoneRegistry.BLOCKS_REGISTRY.getEntries()
